      ...
      <nav class="navbar navbar-default navbar-fixed">
        ...
        <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">ADD PROFESSIONAL DEVELOPMENT/ COMMUNITY SERVICES/ OTHER ACTIVITES</h4>
                            ...
                            <div class="content">
                                <form method="post">
                                    <div class="row">
										<div class="col-md-12">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Describe Your Activity  </label>
                                              
												<textarea rows="5" cols = "40" name="name" id = "name" class="form-control" required placeholder=" Describe your activities upto a limit of 500 words. " ></textarea>
                                            </div>
                                        </div>
