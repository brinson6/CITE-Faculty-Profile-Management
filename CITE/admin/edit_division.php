...
if($_SESSION["id"] != '') {
	  if(isset($_POST['name'])) {
		 ...
		 if($row_cnt>0){
			...
			$msg =  "Division to be Updated is already present. Please Try Again.";
			header('Location:divisions.php?msg='.$msg);
		 }else{ 
		  $sql = 'UPDATE `division`
		  SET `divisionName` = "'.htmlspecialchars($name).'"
		  WHERE divisionId ="'.$_GET["edit"].'"';
...
$sql = 'SELECT * FROM  division where divisionId = "'.$_GET["edit"] .'" ';
...
<div class="main-panel">
        ...
        <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">EDIT DIVISION</h4>
                                    ...
                                    <div class="row">
										<div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" id="name" class="form-control" value="<?php echo $row['divisionName']?>" required>
                                            </div>
                                        </div>

										<div style="clear:both;"></div>

                                    <button type="submit" class="btn btn-info btn-fill pull-right"  >Update Division</button>
