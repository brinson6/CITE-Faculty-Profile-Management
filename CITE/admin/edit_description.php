...
require('header.php');
if($_SESSION["id"] != '') {
 $sql = 'SELECT * FROM  description where id = "'.$_GET["id"] .'" ';
 $result = $conn->query($sql);
   $row = $result->fetch_assoc();
  if(isset($_POST['description'])) {
   $sqlw = 'UPDATE `description`  SET `description` = "'.htmlspecialchars($_POST['description']).'" WHERE id ="'.$_GET["id"].'"';
                                    ...
                                    <div class="row">
                                         ...
                                         <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea rows="5" name="description" id="description" class="form-control" placeholder="Enter Description" ><?php echo $row['description'];?></textarea>
                                            </div>
                                        </div>

                                    <button type="submit" class="btn btn-info btn-fill pull-right" );"> Update Teachinginfo</button>
