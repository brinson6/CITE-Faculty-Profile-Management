...
$sql = 'SELECT * FROM  awards where id = "'.$_GET["id"] .'" ';
       ...
       <nav class="navbar navbar-default navbar-fixed">
        ...
        <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">EDIT HONORS/ AWARDS</h4>
                                    ...
                                    <div class="row">
										...
										<div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="year" id="year" class="form-control" value="<?php echo $row['year']?>" required>
                                            </div>
                                        </div>
										...
										<div class="col-md-4">
                                            <div class="form-group">
												...
												<textarea style="width:400px;" rows="5" name="description" id="description" class="form-control" placeholder = "Enter a description upto a limit of 500 words."><?php echo $row['description']?></textarea>
                                               </div>
                                        </div>
										<div style="clear:both;"></div>

                                    <button type="submit" class="btn btn-info btn-fill pull-right"  >Update Honors/Awards</button>
