...
if($_SESSION["id"] != ''){
 ...
 if(isset($_POST['name'])) {
	...
	/*if($image_status === FALSE && $conn->query($sql2) === TRUE){
		echo '<script language="JavaScript"> alert("Profile Image not Updated as image extension was not in the format of bmp. Rest of the profile data updated. "); </script>';
	}else{
		echo '<script language="JavaScript"> alert("Record Not Updated. Please try again. "); </script>';
	}*/
