...
if($_SESSION["id"] != '') {
	  if(isset($_POST['name'])) {
		  ...
		  SET `name` = "'.htmlspecialchars($name).'"
		  WHERE id ="'.$_GET["id"].'"';
...
<div class="main-panel">
        ...
        <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">EDIT PROFESSIONAL DEVELOPMENT/ COMMUNITY SERVICES/ OTHER ACTIVITES</h4>
                                    ...
                                    <div class="row">
										<div class="col-md-12">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Edit Your Activity </label>
                                              
												<textarea rows="5" cols = "40" name="name" id = "name" class="form-control" required placeholder=" Describe your activities upto a limit of 500 words. "  ><?php echo $row['name']?>"</textarea>
                                            </div>
                                        </div>
										

                                    <button type="submit" class="btn btn-info btn-fill pull-right">Edit Activity</button>
