...
$sql = 'SELECT * FROM  industrial where id = "'.$_GET["id"] .'" ';
...
<div class="main-panel">
        ...
        <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">EDIT INDUSTRIAL EXPERIENCE</h4>
                            ...
                            <div class="content">
								...
								<input type="text" class="form-control" id="organization" name = "organization" required value = "<?php echo $row['organization'] ?>">
							  </div>
							  </div>
										...
										<div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="jobtitle" id="jobtitle" class="form-control" required value = "<?php echo $row['job_title']?>">
                                            </div>
                                        </div>
										...
										<div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="city" id="city" class="form-control" required value = "<?php echo $row['city']?>" >
                                            </div>
                                        </div>
										...
										<div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="state" id="state" class="form-control" required value = "<?php echo $row['state']?>">
                                            </div>
                                        </div>
										<div class="col-md-4">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Country</label>
                                                <input type="text" name="country" id="country" class="form-control" required value = "<?php echo $row['country']?>">
                                            </div>
                                        </div>
										...
										<div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="sdate" id="sdate" class="form-control datepicker" required value = "<?php echo $row['sdate']?>">
                                            </div>
                                        </div>
										<div class="col-md-4">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">End Date</label>
                                                <input type="text" name="edate" id="edate" class="form-control datepicker" required value = "<?php echo $row['edate']?>">
                                            </div>
                                        </div>
										...
										<div class="col-md-12">
                                            <div class="form-group">
												...
												<textarea style="width:400px;" rows="5" name="description" id="description" class="form-control" placeholder = "Please enter a description upto a limit of 500 words." ><?php echo $row['description']?></textarea>
                                               </div>
                                        </div>
										<div style="clear:both;"></div>

                                    <button type="submit" class="btn btn-info btn-fill pull-right">Update Industrial Experience</button>
