...
*/
	...
	$sql_research = 'SELECT * FROM  research where id = "'.$_SESSION["id"] .'" ';
	$result_research = $conn->query($sql_research);
	$row_research = $result_research->fetch_assoc();
	$_SESSION['researchId'] = $row_research['id'];

if(isset($_POST['summary'])) {
	  $sql2 = 'UPDATE `research`  SET `summary` = "'.htmlspecialchars($_POST['summary']).'" WHERE id ="'.$_SESSION["researchId"].'"';
   ...
   <nav class="navbar navbar-default navbar-fixed">
          <div class="container-fluid">
              <div class="navbar-header">
                  ...
                  <a class="navbar-brand">Research Interest</a>
              </div>
      ...
      <div class="header">
            ...
            <div class="collapse navbar-collapse">
                          ...
                          <li>
                          <h5 class="title"> <b>Research Summary  &nbsp </b></h5>
                          </li>
                                    ...
                                    <div class="row">
                                         ...
                                         <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea rows="5" name="summary" id="summary" class="form-control" placeholder="Please Enter Research Summary" ><?php echo $rows['summary']?></textarea>
                                            </div>
                                        </div>

                                    <button type="submit" class="btn btn-info btn-fill pull-left"">Update Intrest</button>
...
?>
                        ...
                        <div class="card">
                            <div class="collapse navbar-collapse">
                                                      ...
                                                      <ul class="nav navbar-nav navbar-left">
                          <li>
                          <h5 class="title"><b> Publications (Please Add Only Top 10 Publications) &nbsp <a href="add_data.php">Create New </a></b></h5>
                          </li>
             ...
             <div class="content table-responsive table-full-width">
                  ...
                  <th>publication type and date</th>
              ...
              <?php  while($row = $result->fetch_assoc()) { ?>
                    ...
                    <td><?php echo $row['publication_type'];?></td>
                                        ...
                                        <td><a href="selected_publications.php?delete=<?php echo $row['id'];?>"  >Delete</a></td>
                                      </tr>
			  ...
			  <?php } }  ?>
                   ...
                   <div class="collapse navbar-collapse">
                      <ul class="nav navbar-nav navbar-left">
                          <li>
                          <h5 class="title"><b> Research Fund (Please Add Only Top 10 Funds) &nbsp     <a href="add_fund.php"> Create New </a></b></h5>
                          </li>
                 </ul>
               </div>
                   <div class="content table-responsive table-full-width">
