...
<div class="main-panel">
        ...
        <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">ADD CERTIFICATION</h4>
   ...
   <?php
	  ...
	  if(isset($_POST['organization'])) {
		...
		// remove if adding script redirect
		$msg = "Record Added";
  ...
  // remove if using script redirects and add the one back at the top
require('header.php');
?>
                        ...
                        <div class="card">
                            ...
                            <div class="content">
                                <form method="post">
                                    ...
                                    <button type="submit" class="btn btn-info btn-fill pull-right">Add Certification</button>
                                    <div class="clearfix"></div>
                                </form>
                    </div>
                        </div>
