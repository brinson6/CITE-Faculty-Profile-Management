...
//require('header.php'); // removed due to Location header redirect
$limit = 10;
      ...
      <nav class="navbar navbar-default navbar-fixed">
        ...
        <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">ADD HONORS/ AWARDS</h4>
   ...
   <?php
	  ...
	  if(isset($_POST['organization'])) {
		  ...
		  `organization` = "'.$organization.'",
		   `name` = "'.$name.'",
		   `year` = "'.$year.'",
		   ' . (!empty($description) ? '`description` = "'.htmlentities($description).'",' : '')
                                    ...
                                    <div class="row">
										...
										<div class="col-md-4">
                                            <div class="form-group">
												...
												<textarea style="width:400px;" rows="5" name="description" id="description" class="form-control" placeholder = "Enter a description upto a limit of 500 words."></textarea>
                                               </div>
                                        </div>
										<div style="clear:both;"></div>

                                    <button type="submit" class="btn btn-info btn-fill pull-right">Add Honors/Awards</button>
                                    <div class="clearfix"></div>
                                </form>
                    </div>
                        </div>
