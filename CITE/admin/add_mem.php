...
<div class="main-panel">
       <nav class="navbar navbar-default navbar-fixed">
        ...
        <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">ADD PROFESSIONAL MEMBERSHIPS</h4>
   ...
   <?php
	  ...
	  if(isset($_POST['name'])) {
		...
		//echo '<script> alert("Professional Membership Added Successfully..") </script>';
                        ...
                        <div class="card">
                            ...
                            <div class="content">
                                <form method="post">
                                    ...
                                    <button type="submit" class="btn btn-info btn-fill pull-right">Add Professional Membership</button>
                                    <div class="clearfix"></div>
                                </form>
                    </div>
                        </div>
