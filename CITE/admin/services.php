...
if($_SESSION["id"] != '') {
 ...
 $sql = 'SELECT * FROM  industrial where faculty_id = "'.$_SESSION["id"] .'"  order by sdate desc ';
 $result_ind = $conn->query($sql);

 $sql_cert = 'SELECT * FROM  certification where faculty_id = "'.$_SESSION["id"] .'" order by date desc';
 $result_cert = $conn->query($sql_cert);

 $sql_awd = 'SELECT * FROM  awards where faculty_id = "'.$_SESSION["id"] .'" order by year desc;';
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
							...
							?>
                                <h4 class="title">INDUSTRIAL EXPERIENCE</h4> <br>
								<h5 class="title">(Please add top 10 industrial experiences)&nbsp;<a href="add_industry.php">Create New</a>
								<p style="color:red" >
								...
								else
								{
									?>
                                        ...
                                        <tr>
                                        	...
                                        	<td><a href="delete_industry.php?delete=<?php echo $row['id'];?>"  onclick="return confirm('Are you sure you want to delete the selected record?');">Delete</a></td>
                                        </tr>
					...
					<div class="col-md-12">
                        <div class="card">
							  ...
							  <div class="header">
                                ...
                                <h4 class="title">CERTIFICATIONS</h4> <br>
								<h5 class="title">(Please add top 10 certifications)&nbsp;<a href="add_cert.php">Create New</a>
								</h5>
                            </div>
								...
								else
								{
									?>
                                        ...
                                        <tr>
                                        	...
                                        	<td><a href="delete_cert.php?delete=<?php echo $row['id'];?>"  onclick="return confirm('Are you sure you want to delete the selected record?');">Delete</a></td>
                                        </tr>
				...
				<div class="col-md-12">
                        <div class="card">
							...
							?>
                                <h4 class="title">HONORS/ AWARDS</h4> <br>
								<h5 class="title">(Please add top 10 honors/ awards)&nbsp;<a href="add_awd.php">Create New</a>
								</h5>
                            </div>
								...
								else
								{
									?>
                                        ...
                                        <tr>
                                        	...
                                        	<td><a href="delete_awd.php?delete=<?php echo $row['id'];?>"  onclick="return confirm('Are you sure you want to delete the selected record?');">Delete</a></td>
                                        </tr>
				...
				<div class="col-md-12">
                        <div class="card">
							...
							<div class="header">
                                ...
                                <h4 class="title">PROFESSIONAL MEMBERSHIPS</h4> <br>
								<h5 class="title">(Please add top 10 professional memberships)&nbsp;<a href="add_mem.php">Create New</a>
								</h5>
                            </div>
								...
								else
								{
									?>
                                        ...
                                        <tr>
                                        	...
                                        	<td><a href="delete_mem.php?delete=<?php echo $row['id'];?>"  onclick="return confirm('Are you sure you want to delete the selected record?');">Delete</a></td>
                                        </tr>
				...
				<div class="col-md-12">
                        <div class="card">
							...
							<div class="header">
                                ...
                                <h4 class="title">PROFESSIONAL DEVELOPMENT/ COMMUNITY SERVICES/ OTHER ACTIVITIES</h4> <br>
								<h5 class="title">(Please add top 10 activities)&nbsp;<a href="add_act.php">Create New</a>
								</h5>
                            </div>
								...
								else
								{
									?>
                                        ...
                                        <tr>
                                        	...
                                        	<td><a href="delete_act.php?delete=<?php echo $row['id'];?>"  onclick="return confirm('Are you sure you want to delete the selected record?');">Delete</a></td>
                                        </tr>
