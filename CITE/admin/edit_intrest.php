...
if($_SESSION["id"] != '') {
  if(isset($_POST['summary'])) {
	  $sql = 'UPDATE `research`  SET `summary` = "'.htmlspecialchars($_POST['summary']).'" WHERE id ="'.$_GET["id"].'"';
                        ...
                        <div class="card">
                            ...
                            <div class="content">
                                <form method="post" onsubmit="return validateForm();">
                                    ...
                                    <button type="submit" class="btn btn-info btn-fill pull-right"">Update Intrest</button>
